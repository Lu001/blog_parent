...
import com.blog.common.entity.PageResult;
import com.blog.common.entity.Result;
import com.blog.common.entity.ResultCode;
import com.blog.domain.system.Role;
import com.blog.domain.system.response.RoleResult;
import com.blog.system.service.RoleService;
...
public class RoleController extends BaseController{
    ...
    public Result findByPage(int page,int pagesize,Role role) throws Exception {
        Page<Role> searchPage = roleService.findByPage(consumerId, page, pagesize);
    ...
    public Result findAll() throws Exception {
        List<Role> roleList = roleService.findAll(consumerId);
